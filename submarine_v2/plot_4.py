...
class plot_four:
    def __init__(self,win, parent,win_width, win_height ,Frame ):
        ...
        self.menu_graph = Canvas(self.win, width = self.win_width/2, highlightthickness = 0)
        ...
        self.graph_can = Canvas(self.win, height = self.win_height/2, width = self.win_width/2, highlightthickness = 0, bg = 'black')
    ...
    def update_graph(self):
        ...
        self.fig_1.canvas.draw()
        self.win.after(50, self.update_graph)
