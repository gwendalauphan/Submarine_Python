...
class plot_five:
    def __init__(self,win, parent,win_width, win_height ,Frame ):
        ...
        #Import des photos
        self.run = PhotoImage(file = "F:/submarine_v_1/ressources/run.png")
        self.back = PhotoImage(file = "F:/submarine_v_1/ressources/back.png")
        self.arrow_top = PhotoImage(file = "F:/submarine_v_1/ressources/arrow_top.png")
        self.arrow_right = PhotoImage(file = "F:/submarine_v_1/ressources/arrow_right.png")
        self.arrow_down = PhotoImage(file = "F:/submarine_v_1/ressources/arrow_down.png")
        self.arrow_left = PhotoImage(file = "F:/submarine_v_1/ressources/arrow_left.png")

        #Canvas Principale
        self.canvas_3d = Canvas(self.win, height = self.win_height/2, width = 7*self.win_height/16, highlightthickness = 0)
        ...
        self.button_arrow_top = Button(self.canvas_bis, highlightthickness=0, borderwidth = 0 ,cursor ='hand2', command = lambda: self.update_graph_rot_ver(0)).place(x = 25, y = 30)
    ...
    def update_sub(self):
        ...
        self.sub = self.ax_1.scatter3D(self.parent.coor[0][0],self.parent.coor[0][1],self.parent.coor[0][2], s = 40, c = 'white', alpha = 1)
        self.fig_1.canvas.draw()"""
        self.win.after(5000, self.update_sub)
