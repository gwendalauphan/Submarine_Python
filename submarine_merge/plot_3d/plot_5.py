...
# Keep 's' keyboard control for submarine speed; avoid Matplotlib save shortcut.
...
class plot_five:
    def __init__(self,win, parent,win_width, win_height ,Frame ):
        self.win = win
        self.parent = parent
        self.win.protocol("WM_DELETE_WINDOW", self.parent.on_close)
        ...
        #Import des photos
        self.run = PhotoImage(file = "ressources/run.png")
        self.back = PhotoImage(file = "ressources/back.png")
        self.arrow_top = PhotoImage(file = "ressources/arrow_top.png")
        self.arrow_right = PhotoImage(file = "ressources/arrow_right.png")
        self.arrow_down = PhotoImage(file = "ressources/arrow_down.png")
        self.arrow_left = PhotoImage(file = "ressources/arrow_left.png")
        ...
        self.ax_1 = self.fig_1.add_subplot(111, projection='3d')
