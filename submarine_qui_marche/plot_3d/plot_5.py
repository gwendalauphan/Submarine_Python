...
class plot_five:
    def __init__(self,win, parent,win_width, win_height ,Frame ):
        ...
        #Import des photos
        self.run = PhotoImage(file = "F:/submarine/ressources/run.png")
        self.back = PhotoImage(file = "F:/submarine/ressources/back.png")
        self.arrow_top = PhotoImage(file = "F:/submarine/ressources/arrow_top.png")
        self.arrow_right = PhotoImage(file = "F:/submarine/ressources/arrow_right.png")
        self.arrow_down = PhotoImage(file = "F:/submarine/ressources/arrow_down.png")
        self.arrow_left = PhotoImage(file = "F:/submarine/ressources/arrow_left.png")
