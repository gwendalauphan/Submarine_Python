...
class plot_four:
    def __init__(self,win, parent,win_width, win_height ,Frame ):
        ...
        self.line1, = plt.plot(self.parent.liste_time, self.parent.liste_acc_x, c = "blue")
        self.line2, = plt.plot(self.parent.liste_time, self.parent.liste_acc_y, c = "red")
        self.line3, = plt.plot(self.parent.liste_time, self.parent.liste_acc_z, c = "yellow")
    ...
    def update_graph(self):
        ...
        if self.v.get() == 0 and len(self.parent.liste_v_x)>0:
            self.line1, = plt.plot(self.parent.liste_time, self.parent.liste_v_x, c = "blue")
            self.line2, = plt.plot(self.parent.liste_time, self.parent.liste_v_y, c = "red")
            self.line3, = plt.plot(self.parent.liste_time, self.parent.liste_v_z, c = "yellow")
            ...
            self.line1, = plt.plot(self.parent.liste_time, self.parent.liste_acc_relatif, c = "blue")
            self.line2, = plt.plot(self.parent.liste_time, self.parent.liste_v_relatif, c = "red")

        self.ax.set_xlim(left = max(0,self.parent.t2 -10), right = self.parent.t2)
